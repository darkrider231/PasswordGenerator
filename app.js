...
function randomIndex(str){
  ...
  function generatePassword(upper, lower, number, symbol, length){
    ...
    // Build password with a for loop
    ...
    // Removing extra characters if necessary (The above loop will create a password that may not match the length selectedif that length is not a multiple of the number of types selected)
